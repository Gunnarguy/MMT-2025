...
export const FUEL_STOPS = [
  {
    ...
    mileMarker: 335,
    milesOnTank: 335,
    tankPercentBefore: "19% (3.0 gal remaining)",
    action: "Full fill-up (~13.0 gal)",
    why: "Tops off the tank after the Palatine → Grand Rapids → Ludington → Sleeping Bear Dunes run. Covers tomorrow’s Charlevoix & Petoskey drive up to Mackinaw City.",
  },
  {
    id: "fuel-2",
    dayId: "d5",
