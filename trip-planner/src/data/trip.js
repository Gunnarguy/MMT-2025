  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    stops: [
      ...
      },
      {
        ...
        where: "ORD Terminal 3 · 3:20 PM Departure",
        address: "Chicago O'Hare International Airport, Terminal 3, Chicago, IL 60666",
        coords: [41.9742, -87.9073],
        status: "booked",
        duration: "Return car by 1:00 PM Central",
        blurb:
          "Return Budget rental SUV at the Multi-Modal Facility (MMF) by 1:00 PM, take the ATS train to Terminal 3, drop bags, and clear TSA for the 3:20 PM flight to SFO (AA 1253).",
        tips: [
          "Budget car return is at the Multi-Modal Facility (MMF), 10255 W. Zemke Blvd.",
          "The ATS train runs every 3–5 minutes from MMF directly to Terminal 3.",
          "Boarding begins at 2:45 PM Central.",
        ],
      },
    ],
    momSaid: `9/21
