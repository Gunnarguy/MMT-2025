...
SLEEP HERE 2 nights: Lighthouse View Hotel, 699 N Huron Ave, Mackinaw City, MI 49701  Ph 231/436.5304 $298`,
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    route: "7:30 boat over, breakfast, the town all day, boat back when you feel like it",
    miles: 0,
    driveMinutes: 0,
    sunset: "7:46 PM",
    sleep: bed("mackinaw-city"),
    lede:
      "Walk to the dock at 6:55 for the 7:30 boat. Breakfast on Main Street, then the town for as long as you want it: shops, fudge, the harbor. Bikes if the mood strikes, the fort if it doesn't. Boats back run hourly all afternoon, so nothing about the day is on a clock except the one that gets you there.",
    flags: [
      {
        level: "ok",
    ...
    stops: [
      ...
      },
      {
        ...
        where: "9:00 · the main event · as long as you want",
      ...
      },
      {
        ...
        where: "Optional · $14 · a walk west of town",
        address: "286 Grand Ave, Mackinac Island, MI 49757",
        coords: [45.8478, -84.6238],
        status: "confirmed",
        cost: "$14 adult · $7 ages 6–12",
        hours: "Admissions 9:00 AM – 6:00 PM daily",
        duration: "1 hour",
        blurb: "660 feet of front porch with rocking chairs and the Straits in front of it. Non-guests pay admission, which also covers the gardens and the public rooms.",
        tips: [
          "Fifteen minutes on foot up from Main Street, or a five-minute ride.",
          "The pool is not included. The evening dress code is not your problem at this hour.",
        ],
        source: "Grand Hotel admissions page; 2026 rate",
