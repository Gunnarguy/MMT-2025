...
TRY:  White Pine Village, Port Museum, Check out dock`,
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    lede:
      "Out of Ludington at 8:00, straight to the dunes. The scenic drive to the 450-foot overlook, then the Dune Climb (climb it or take the bench), then Glen Haven on the water. Lunch on the docks at Fishtown, Petoskey stones on Van's Beach, and Traverse City by mid-afternoon with the evening open.",
    flags: [
      {
        level: "ok",
    ...
    stops: [
      ...
      },
      {
        ...
        kind: "anchor",
        name: "The Dune Climb",
        where: "11:00 · 45 minutes · climb it, or take the bench",
        ...
        tips: [
          ...
          "Tired after the climb: shorten Glen Haven, keep Fishtown.",
        ],
      ...
      },
      {
        ...
        where: "11:50 · 30 minutes · the old logging village on the lake",
...
export const HIGHLIGHTS = [
  ...
  },
  {
    ...
    body:
      "Straight to the dunes: the scenic drive to the Lake Michigan Overlook, the Dune Climb (climb it or watch), Glen Haven on the water, then lunch on the docks at Fishtown.",
    tag: "$25 per car",
  },
  {
    dayId: "d1",
