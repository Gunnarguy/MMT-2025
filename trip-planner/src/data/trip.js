...
TRY:  White Pine Village, Port Museum, Check out dock`,
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    lede:
      "Out of Traverse City at 8:30, up the shore. Charlevoix for the stone Mushroom Houses and the drawbridge, lunch in Petoskey, an hour on the stone beach at Magnus Park, then up to the Straits by 2:30 with the afternoon for the bridge and the water. Two nights in Mackinaw City; the island is tomorrow.",
    flags: [
      {
        level: "info",
    ...
    legs: [
      {
        ...
        minutes: 75,
        miles: 50,
        note: "US-31 north along East Bay, then the long straight run up the shore. Mom's “1 hr” is optimistic; call it 75 minutes with the bay traffic out of town.",
      },
      {
    ...
    stops: [
      {
        ...
        where: "9:45 · 45 minutes · Boulder Park and Park Ave, west side of Round Lake",
      ...
      },
      {
        ...
        where: "10:30 · 45 minutes · Bridge Street, the channel and the pier",
      ...
      },
      {
        ...
        kind: "optional",
        name: "Castle Farms",
        where: "Extra · 90 minutes · 5052 M-66, if the morning is going slowly",
      ...
      },
      {
        ...
        where: "11:45 · lunch · Gaslight District, on the bluff above the bay",
      ...
      },
      {
        ...
        where: "12:45 · 45 minutes · 901 W Lake St, five minutes from lunch",
      ...
      },
      {
        ...
        where: "2:30 · 699 N Huron Ave · two nights",
