...
TRY:  White Pine Village, Port Museum, Check out dock`,
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    index: 2,
    date: "2026-09-16",
    title: "The dunes, all of it, then Fishtown",
    route: "Ludington → Frankfort → Loon Lake → Sleeping Bear Dunes → Glen Haven → Leland (Fishtown) → Traverse City",
    miles: 141,
    driveMinutes: 225,
    sunset: "7:53 PM",
    ...
    lede:
      "Out of Ludington at 8:00 and up the shore on M-22. Every one of Mom's four dune items is on the board in the order the road hands them to you: toes in Loon Lake, the Pierce Stocking Scenic Drive to the 450-foot overlook, the Dune Climb (climb it or sit on the bench and heckle), then Glen Haven and the Maritime Museum. Late lunch on the docks at Fishtown, Petoskey stones on Van's Beach, and Traverse City by four with the whole evening open. Everything marked optional can be dropped without touching anything else.",
    flags: [
      {
        level: "ok",
      ...
      },
      {
        ...
        body: "Village Cheese Shanty closes at 5 and Carlson's Fishery is 9–5 on Wednesdays. The plan lands you there around 1:30, which is two hours of slack, but the dunes are the thing that eats time.",
        fix: "If it is past 12:30 and you are still at the dunes, skip Glen Arbor and the Maritime Museum, not Fishtown.",
      },
    ],
    legs: [
      {
        label: "Ludington → Frankfort",
        at: 1,
        minutes: 75,
        miles: 55,
        note: "US-31 north to Manistee, then M-22 up the shore. Two lanes, no tolls, no traffic to speak of on a September Wednesday.",
      },
      {
        label: "Frankfort → Loon Lake",
        at: 2,
        minutes: 20,
        miles: 14,
        note: "M-22 north over the Platte River. The Loon Lake lot is on the right just after the bridge, before Lake Michigan Road.",
      },
      {
        label: "Loon Lake → Empire and the scenic drive",
        at: 3,
        minutes: 18,
        miles: 12,
        note: "M-22 into Empire. Wilco Road (Empire Bluff) is on the left 1.7 miles before town; the scenic drive entrance is on M-109 just north of town.",
      },
      {
        ...
        minutes: 35,
        miles: 21,
        note: "M-109 to M-22 north through Glen Arbor (five minutes in, Cherry Republic on the main street) and on to Leland. The prettiest twenty miles of the trip.",
      },
      {
        ...
        minutes: 45,
        miles: 30,
        note: "M-22 south, M-204 across the peninsula through Lake Leelanau, M-72 into town, US-31 north along East Bay to the inn.",
      },
    ],
    stops: [
      {
      ...
      },
      {
        id: "d2-frankfort",
        kind: "optional",
        name: "Coffee in Frankfort",
        where: "9:15 · 15 minutes · Perks of Frankfort, Main Street",
        address: "429 Main St, Frankfort, MI 49635",
        coords: [44.6337, -86.2352],
        status: "confirmed",
        hours: "7 AM – 5 PM daily",
        duration: "15 min",
        blurb: "The M-22 coffee stop, halfway between the inn and the park. Main Street is a block off the harbor if anyone wants to stretch.",
        tips: ["Skip it if the car already has coffee in it; the next bathrooms are at Loon Lake."],
        source: "Perks of Frankfort",
        sourceUrl: "https://www.perksoffrankfort.com/",
      },
      {
        id: "d2-loon",
        fromMom: true,
        kind: "stop",
        name: "Loon Lake, toes in",
        where: "9:50 · 15 minutes · the lot off M-22 just past the Platte River",
        address: "Loon Lake Access, M-22, Honor, MI 49640",
        coords: [44.7089, -86.1261],
        status: "confirmed",
        cost: "Included in the pass",
        duration: "10–15 min",
        blurb: "Mom's 'dip your toes in the tranquil Loon Lake'. Sandy bottom, a dock next to the boat ramp, picnic shelter, real restrooms. The most accessible inland lake in the park, and it is on the way, so it costs nothing.",
        tips: [
          "Wade from the dock or the ramp; the bottom is firm sand.",
          "Best restrooms before the scenic drive.",
        ],
        source: "NPS, Loon Lake Access (GPS 44.7089, -86.1261)",
        sourceUrl: "https://www.nps.gov/places/000/loon-lake-access.htm",
      },
      {
        id: "d2-empire-bluff",
        kind: "optional",
        name: "Empire Bluff Trail",
        where: "Extra · 45 minutes · 1.5 miles round trip · if there is energy",
        address: "Empire Bluff Trailhead, S Wilco Rd, Empire, MI 49630",
        coords: [44.7992, -86.0585],
        status: "confirmed",
        cost: "Included in the pass",
        duration: "45 min",
        blurb: "The best view-per-step in the park: a gentle 0.75 miles through beech-maple woods to a boardwalk 400 feet above the lake, looking north at the whole dune. Not on Mom's list; here because it is the walk people wish they had done.",
        tips: [
          "Tree roots and one short set of stairs; fine in sneakers, slow for bad knees.",
          "Costs 45 minutes. Take them from the afternoon beach time at the inn, not from Fishtown.",
        ],
        source: "Friends of Sleeping Bear, Empire Bluff",
        sourceUrl: "https://www.friendsofsleepingbear.org/empire-bluff",
      },
      {
        id: "d2-scenic",
        fromMom: true,
        ...
        where: "10:20 · about 55 minutes · one-way 7.4-mile loop",
      ...
      },
      {
        ...
        kind: "anchor",
        name: "The Dune Climb",
        where: "11:20 · 45 minutes · climb it, or take the bench",
        address: "6900 S Dune Hwy (M-109), Glen Arbor, MI 49636",
        coords: [44.8833, -86.0408],
        status: "confirmed",
        cost: "Included in the pass",
        duration: "30–45 min",
        blurb: "Mom's exact words: 'Trek up the Dune Climb - or sit back and watch the rest of your party climb.' A 110-foot wall of sand rising straight off the parking lot. Whoever climbs gets the Glen Lake view from the top in 10 to 20 minutes; whoever doesn't gets a bench, shade, and the show. Both count.",
        tips: [
          "Climb only to the first crest; the trail beyond it to Lake Michigan is 3.5 miles of open sand round trip and takes three hours.",
          "Barefoot or sneakers you don't mind emptying. Running down is the fun part.",
          "Water, restrooms and picnic tables at the lot; the Dune Center store sells drinks.",
          "Tired after the climb: drop the Maritime Museum and Glen Arbor, keep Glen Haven beach and Fishtown.",
        ],
      ...
      },
      {
        ...
        where: "12:10 · 25 minutes · the old logging village on the lake",
        ...
        tips: [
          ...
          "Second toe-dip of the day, this one in Lake Michigan. It will be cold.",
        ],
      ...
      },
      {
        ...
        fromMom: true,
        kind: "optional",
        name: "Sleeping Bear Point Maritime Museum",
        where: "12:35 · 20 minutes · 1.5 miles west of the village",
        address: "Sleeping Bear Point Coast Guard Station, Sleeping Bear Dunes Rd, Glen Arbor, MI 49636",
        coords: [44.9083, -86.0336],
        status: "check",
        cost: "Included in the pass",
        hours: "Daily 11–5 through Labor Day; September hours not published",
        duration: "20 min",
        blurb: "Mom's 'and the Maritime Museum'. The 1901 Life-Saving Station, with the surfboat, the breeches-buoy rig and the surfmen's bunks upstairs. Listed open on the park's conditions page; the post–Labor Day staffing is the unknown.",
        tips: [
          "If the door is locked, the grounds and the beach behind the station are still worth the five minutes.",
          "Park HQ 231-326-4700 for hours.",
        ],
        source: "NPS conditions page 2026-09-10; Sleeping Bear Dunes visitors bureau (hours)",
        sourceUrl: "https://www.sleepingbeardunes.com/listing/sleeping-bear-dunes-maritime-museum/1659/",
      },
      {
        id: "d2-glenarbor",
        kind: "optional",
        name: "Cherry Republic, Glen Arbor",
        where: "About 1:00 · 15 minutes · on M-22 in the middle of Glen Arbor",
        address: "6026 S Lake St, Glen Arbor, MI 49636",
        coords: [44.8963, -85.9893],
        status: "confirmed",
        hours: "Store 10–8 · winery 11–7 · Public House 11–9",
        duration: "15 min",
        blurb: "Cherry everything, with free samples, a tasting bar and a patio. The right snack if lunch at Fishtown is starting to feel far away, and the souvenir stop of the peninsula.",
        tips: ["Cherry salsa and the dried cherries travel; the pie does not."],
        source: "Cherry Republic, Glen Arbor store page",
        sourceUrl: "https://www.cherryrepublic.com/pages/cherry-republic-in-glen-arbor",
      },
      {
        id: "d2-fishtown",
        kind: "food",
        name: "Fishtown, Leland",
        where: "About 1:30 · lunch on the dock · 1.5 hours",
      ...
      },
      {
        ...
        where: "About 3:00 · 20 minutes · two minutes' walk south of the harbor",
      ...
      },
      {
        ...
        where: "About 4:00 · 1465 US-31 N, on East Grand Traverse Bay",
        ...
        tips: [
          ...
          "The TART trail runs along US-31 in front of the inn: a flat paved walk toward town if legs want it.",
        ],
      ...
      },
      {
        ...
        where: "5:30 · a glass before dinner · in the Village at Grand Traverse Commons",
        address: "806 Red Dr #100, Traverse City, MI 49684",
        coords: [44.7515, -85.6440],
        status: "confirmed",
        hours: "Wed 12–7 PM",
        duration: "45 min",
        blurb: "Mom's 'wineries, distilleries': the one you can do tonight. An urban winery and cidery in the old state hospital grounds, ten minutes from the inn, pouring until seven on a Wednesday. The peninsula wineries mostly shut by five or six, so they are a Thursday-morning thing if at all.",
        tips: ["Tasting flights at the bar, no reservation needed on a weekday. The Commons buildings themselves are worth the walk."],
        source: "Left Foot Charley (hours checked 2026-09-15)",
        sourceUrl: "https://www.leftfootcharley.com/",
      },
      {
        id: "d2-front-street",
        fromMom: true,
        ...
        status: "free",
        duration: "1.5 hours",
        blurb: "Mom's 'tour town, eat well'. Front Street is six walkable blocks of restaurants: Amical (French-ish, bay view, 229 E Front), Sorellina (Italian), 7 Monks (beer, open late), Modern Bird for something newer. Nothing is booked; a Wednesday in September does not need it.",
        tips: [
      ...
      },
      {
        id: "d2-sunset",
        kind: "sight",
        name: "Sunset from the inn's beach",
        where: "7:53 · straight across the bay",
        coords: [44.7772, -85.5713],
        status: "free",
        blurb: "East Grand Traverse Bay faces west from Brio's sand, so the sun goes down over the water and the Old Mission Peninsula. Back from dinner by 7:30 and it is free.",
        tips: ["Thursday leaves at 8:30 for Charlevoix; a late night here costs nothing tomorrow."],
        source: "timeanddate, Traverse City sunset 2026-09-16",
        sourceUrl: "https://www.timeanddate.com/sun/usa/traverse-city",
      },
    ],
    momSaid:
...
export const HIGHLIGHTS = [
  ...
  },
  {
    ...
    body:
      "Loon Lake, the scenic drive to the Lake Michigan Overlook, the Dune Climb (climb it or watch), Glen Haven and the Maritime Museum: all four of Mom's dune stops, then a late lunch on the docks at Fishtown.",
    tag: "$25 per car",
  },
  {
    dayId: "d1",
