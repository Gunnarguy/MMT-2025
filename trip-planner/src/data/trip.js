...
TRY:  White Pine Village, Port Museum, Check out dock`,
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    flags: [
      {
        level: "warn",
        title: "SkyBridge tickets are dated",
        body: "Admission is sold online per date and includes the chairlift. Buy three for Thursday, September 17 before you go; the price for all three shows in the checkout.",
        fix: "Ticket link is on the SkyBridge stop below. Open 11 to 6:30, weather permitting.",
      },
      {
        level: "info",
    ...
    stops: [
      ...
      },
      {
        ...
        phone: "855-688-7024",
        url: "https://shop.boynemountain.com/l/skybridge-michigan/p/skybridge-ticket",
        urlLabel: "Tickets",
        ...
        tips: [
          "Tickets are dated and sold online; buy three for Thursday tonight rather than at the window.",
