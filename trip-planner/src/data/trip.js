...
SLEEP HERE 2 nights: Lighthouse View Hotel, 699 N Huron Ave, Mackinaw City, MI 49701  Ph 231/436.5304 $298`,
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    index: 5,
    date: "2026-09-19",
    title: "Oktoberfest, then Canada",
    route: "Mackinaw City → Frankenmuth → Port Huron → Point Edward, ON",
    miles: 298,
    driveMinutes: 330,
    sunset: "7:45 PM",
    sleep: bed("sarnia"),
    legFrom: "Lighthouse View Motel, 699 N Huron Ave, Mackinaw City, MI 49701",
    lede:
      "Out of Mackinaw City by 8:00 and straight down I-75, three hours and twenty minutes on one road. Frankenmuth from about 11:20: the petting farm if you want it, then Oktoberfest in the pavilion from noon for lunch and a beer. Back on the road by 3:00, over the Blue Water Bridge around 5:00, in Canada for the night.",
    flags: [
      {
        level: "ok",
        title: "Oktoberfest is under a roof",
        body: "It runs inside the Harvey Kern Community Pavilion at Heritage Park, a Munich-patterned festhall built in 2005 precisely to keep the crowd out of the sun and the rain. Weather does not cancel it.",
      },
      {
        level: "warn",
        title: "Oktoberfest does not serve schnitzel",
        body: "The official menu is bratwurst with kraut ($9), pulled pork ($10), frankfurters ($6), a German cold plate ($10), and a $25 German meal package of weisswurst, jaeger meatballs, roast chicken, spätzle and sweet-and-sour cabbage. No schnitzel anywhere on it.",
        fix: "Schnitzel is at the Bavarian Inn, five minutes away, indoors, 11 AM to 9 PM. Hunter's schnitzel is pork in mushroom cream; Wiener schnitzel is the breaded veal. Eat there, drink at the festival.",
      },
      {
        level: "info",
        title: "Tomorrow is grey, not wet",
        body: "Frankenmuth runs 67 and 56 with 0.00 inches forecast and the hourly chance peaking near 38 percent late afternoon. Mackinaw City is 12 percent in the morning, Sarnia 36 percent at night. Bring a shell, not a plan B.",
      },
      {
        level: "info",
        title: "Blue Water Bridge is cashless",
        body: "$5 USD at the US plaza, card or Apple Pay, no booth cash. Fill the tank on the American side; Ontario fuel costs noticeably more.",
      },
    ],
    legs: [
      {
        ...
        minutes: 200,
        miles: 203,
        note: "I-75 south the whole way, one road, no decisions. Grayling and West Branch both have gas and bathrooms right off the highway. Skipping Colonial Michilimackinac in town is what buys you the Frankenmuth afternoon.",
      },
      {
        ...
        minutes: 100,
        miles: 89,
        note: "I-69 east. Fort Gratiot Light sits at the foot of the bridge, so it costs no detour at all.",
      },
      {
        ...
        minutes: 30,
        miles: 6,
        note: "Blue Water Bridge and Canadian customs. Passports out, and know where you are sleeping tonight because they ask.",
      },
    ],
    stops: [
      {
        id: "d5-farm",
        kind: "optional",
        name: "Grandpa Tiny's Farm",
        where: "11:30 · optional · about $8 each, 45 minutes",
        address: "7775 Weiss St, Frankenmuth, MI 48734",
        coords: [43.3229, -83.7549],
        status: "check",
        cost: "About $8 a head · card only, no cash",
        hours: "Wednesday to Sunday, 10 to 5",
        duration: "30–60 min",
        phone: "989-652-5437",
        blurb: "A working historical farm and petting farm on Weiss Street, across from Bronner's. Goats, sheep, horses, chickens, and the old farm buildings to walk through. Most visits run half an hour to an hour.",
        tips: [
          "Call ahead: their daily hours move with private events, and I could not confirm how much of it is under cover if it drizzles.",
          "Park across at Bronner's if their lot is full.",
        ],
        source: "Grandpa Tiny's Farm; Frankenmuth CVB directory (checked 2026-09-18)",
        sourceUrl: "https://www.grandpatinys.com/admission",
      },
      {
        id: "d5-oktoberfest",
        kind: "anchor",
        ...
        where: "12:15 · the main event · Heritage Park pavilion",
        address: "Heritage Park, 601 Weiss St, Frankenmuth, MI 48734",
        coords: [43.3336, -83.7379],
        status: "confirmed",
        cost: "$10 a head at the gate · 15 and under free",
        hours: "Saturday noon to midnight",
        duration: "1.5–2 hours",
        url: "https://frankenmuthfestivals.com/frankenmuth-oktoberfest",
        urlLabel: "Festival site",
        blurb: "The only Oktoberfest outside Munich to run with the blessing of the original, since 1996. It happens inside the Harvey Kern Pavilion: long tables, an oompah band, dancing, and Hofbräuhaus Oktoberfest beer brewed for it.",
        tips: [
          "Gates at noon on Saturday. You arrive around 11:20, so the farm or Bronner's fills the gap.",
          "Food is brats, pulled pork, frankfurters and a $25 German plate. Pretzels are Bavarian Inn's.",
          "Cash a card at the gate, $10 each, kids free. Saturday is the busy day of the four.",
        ],
        source: "Frankenmuth Festivals, official Oktoberfest page and menu (checked 2026-09-18)",
        sourceUrl: "https://frankenmuthfestivals.com/oktoberfest-menu",
      },
      {
        id: "d5-bavarian-inn",
        kind: "optional",
        name: "Bavarian Inn, if it has to be schnitzel",
        where: "Optional · 713 S Main St · open 11 to 9",
        address: "713 S Main St, Frankenmuth, MI 48734",
        coords: [43.3295, -83.7386],
        status: "confirmed",
        cost: "Schnitzel plates around $25 · chicken dinner $31.99",
        hours: "Friday and Saturday 11 AM – 9 PM",
        duration: "1 hour",
        phone: "989-652-9941",
        blurb: "The actual schnitzel in this town. Hunter's schnitzel is pork loin under mushroom cream; Wiener schnitzel is the hand-breaded veal. Indoors, five minutes from the festival grounds, and the covered bridge is right outside.",
        tips: [
          "Walk-in on an Oktoberfest Saturday can mean a wait. Call 989-652-9941 or book on OpenTable from the car.",
          "This is the same place as the famous chicken dinner, so nobody has to agree on one thing.",
          "Zehnder's across the street is the other chicken house if the wait here is silly.",
        ],
        source: "Bavarian Inn Restaurant menu and hours (checked 2026-09-18)",
        sourceUrl: "https://www.bavarianinn.com/dine/",
      },
      {
        id: "d5-bronners",
        kind: "stop",
        name: "Bronner's CHRISTmas Wonderland",
        where: "2:15 · free, and entirely indoors",
        address: "25 Christmas Ln, Frankenmuth, MI 48734",
        coords: [43.3179, -83.7381],
        status: "free",
        cost: "Free",
        hours: "Saturday 9 AM – 9 PM",
        duration: "45 min",
        blurb: "The world's largest Christmas store, the size of several football fields, free to walk through, open 361 days a year. Genuinely absurd and the best roof in town if the sky opens.",
        tips: ["Open until 9, so it also works as the thing you do if anything else runs long."],
        source: "Bronner's store hours (checked 2026-09-18)",
        sourceUrl: "https://www.bronners.com/store-hours",
      },
      {
        id: "d5-fort-gratiot",
        kind: "optional",
        name: "Fort Gratiot Lighthouse",
        where: "4:40 · optional · at the foot of the bridge",
        address: "2802 Omar St, Port Huron, MI 48060",
        coords: [43.0058, -82.4225],
        status: "check",
        duration: "30 min",
        blurb: "Michigan's oldest lighthouse, 1829, standing where Lake Huron pours into the St. Clair River, directly at the bridge approach. Zero detour, and the last American thing you see.",
        tips: ["Top off the tank here. Ontario fuel is dearer and you cross in twenty minutes."],
      },
      {
        id: "d5-waterfront",
        kind: "stop",
        name: "Point Edward waterfront",
        where: "Evening · from the hotel door · sunset 7:45",
        address: "Point Edward, ON, Canada",
        coords: [42.9989, -82.42],
        status: "free",
        cost: "Free",
        blurb: "The waterfront trail genuinely starts at the hotel, with the Blue Water Bridge lit overhead and freighters coming down the river. Mom's note that Centennial Park is 'just north of hotel' overstates it; that one is a drive. This one is not.",
        tips: ["Sunset is 7:45. The walk only works if you clear the bridge by about 7."],
      },
    ],
...
SLEEP HERE: Sheraton Four Points 1498 Venetian Boulevard Pt Edward, Ph 519.336.4130  $169 Canadian`,
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    index: 6,
    date: "2026-09-20",
    title: "Canada home, by way of Julia's",
    route: "Point Edward → Blue Water Bridge → Julia's (Van Buren Twp) → Palatine",
    miles: 380,
    driveMinutes: 436,
    sunset: "6:52 PM CT",
    sleep: null,
    legFrom: "Four Points by Sheraton, 1498 Venetian Blvd, Point Edward, ON",
    lede:
      "The long one. Out of Point Edward at 8:00, back across the bridge into Michigan, down I-94 to Julia's in Van Buren Township for the wine and a proper visit, then the five and a half hours west to Palatine. You gain an hour at the Illinois line, so an 8:00 start puts you at Mom's around a quarter to five.",
    flags: [
      {
        level: "warn",
        title: "This is the longest driving day of the trip",
        body: "380 miles and about seven hours twenty behind the wheel, before the border and before the visit. Leave Point Edward at 8:00 ET, reach Julia's about 9:45, and you can give her two hours and still be in Palatine by 4:45 Central.",
        fix: "Every hour you linger at Julia's lands after dark in Palatine. Fuel and bathrooms at Battle Creek or the Indiana line, not before.",
      },
      {
        level: "info",
        title: "Passports out at the bridge",
        body: "You are re-entering the United States, so all three physical passports come out at the Port Huron plaza. The toll is cashless. If anyone bought wine or beer in Canada, the duty-free allowance is one liter a person.",
      },
      {
        level: "ok",
        title: "The Belleville hotel is off",
        body: "Sunday now ends at Mom's house in Palatine rather than a hotel near Detroit Metro, so the provisional Hampton Inn night and its $267 are gone from the budget.",
      },
    ],
    legs: [
      {
        label: "Point Edward → Blue Water Bridge",
        at: 0,
        minutes: 10,
        miles: 4,
        note: "The bridge is visible from the hotel. US customs on the far side; Sunday mornings are usually quick.",
      },
      {
        label: "Port Huron → Julia's, Van Buren Township",
        at: 1,
        minutes: 95,
        miles: 85,
        note: "I-94 the whole way, around the top of Detroit and out past the airport. Ninety-five minutes with no traffic worth naming on a Sunday.",
      },
      {
        label: "Julia's → Palatine",
        at: 2,
        minutes: 331,
        miles: 291,
        note: "I-94 west through Ann Arbor, Jackson and Kalamazoo, around the bottom of the lake through Indiana, then I-80/94 and IL-53 north. Clocks go back an hour at the Illinois line.",
      },
    ],
    stops: [
      {
        id: "d6-border",
        kind: "stop",
        name: "Blue Water Bridge, back into the States",
        where: "8:10 · passports out · cashless toll",
        address: "Blue Water Bridge, Point Edward, ON",
        coords: [42.9989, -82.4211],
        status: "free",
        duration: "20–40 min",
        blurb: "Four miles from the hotel door to US primary inspection. They ask where you have been, how long, and what you are bringing back. Short answers.",
        tips: [
          "All three physical passports in a hand, not in a bag in the trunk.",
          "One liter of alcohol a person comes back duty-free. Declare anything over it rather than discover it.",
          "Last cheap fuel is on the American side; you filled up Saturday, so this is only if you are low.",
        ],
      },
      {
        id: "d6-julias",
        kind: "anchor",
        name: "Julia's, for the wine and a visit",
        where: "9:45 · wine and a couple of hours",
        address: "44134 Harmony Lane, Van Buren Twp, MI 48111",
        coords: [42.2177, -83.4767],
        status: "confirmed",
        duration: "1.5–2 hours",
        blurb: "Off I-94 in Van Buren Township, just past the airport. Pick up the wine and actually sit down for a while; it is the only unhurried thing on the calendar today.",
        tips: [
          "Pack the wine flat in the footwell, not loose in the back. You have five and a half hours of highway after this.",
          "Leaving by noon Eastern is what keeps Palatine in daylight.",
        ],
      },
      {
        id: "d6-palatine",
        kind: "stop",
        name: "Palatine, Mom's house",
        where: "About 4:45 CT · 2020 Crestwood Lane",
        address: "2020 Crestwood Lane, Palatine, IL 60074",
        coords: [42.1103, -88.0342],
        status: "free",
        blurb: "Back where the trip started, an hour richer than the clock in the car says. Last night of the trip, and nothing to pack for but the flight.",
        tips: ["Sunset is 6:52 PM CT. Tomorrow is fifteen miles of driving and nothing else."],
      },
    ],
    momSaid:
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    index: 7,
    date: "2026-09-21",
    title: "Fifteen miles, then home",
    route: "Palatine → O'Hare → SFO",
    miles: 15,
    driveMinutes: 25,
    sunset: "6:50 PM CT",
    sleep: null,
    legFrom: "2020 Crestwood Lane, Palatine, IL 60074",
    lede:
      "You slept in Palatine, so the drive that used to eat this morning is already done. A slow breakfast, top off the tank on Touhy, the Sienna back at the Multi-Modal Facility by 1:00, the train to Terminal 3, and AA 1253 at 3:20.",
    flags: [
      {
        level: "info",
        title: "The only hard deadline is 1:00 PM",
        body: "Budget wants the car at the Multi-Modal Facility by 1:00 PM Central. From Crestwood Lane that is twenty-five minutes, so leaving at 11:45 is comfortable and leaving at 12:15 is not.",
        fix: "Top off at the Shell at 600 E Touhy Ave before you turn in; the refuel charge at the counter is punitive.",
      },
      {
        level: "info",
        title: "Boarding is 2:45, the door shuts at 3:05",
        body: "AA 1253 leaves O'Hare Terminal 3 at 3:20 PM for SFO. The ATS train from the rental facility to T3 runs every three to five minutes and takes about ten.",
      },
    ],
    legs: [
      {
        label: "Palatine → O'Hare, Multi-Modal Facility",
        at: 1,
        minutes: 25,
        miles: 15,
        note: "IL-53 south to I-90 east, then the rental-return ramp at 10255 W Zemke Blvd. Shell at 600 E Touhy Ave is the fuel stop on the way.",
      },
    ],
    stops: [
      {
        id: "d7-morning",
        kind: "stop",
        name: "Morning in Palatine",
        where: "Until 11:45 · nothing scheduled",
        address: "2020 Crestwood Lane, Palatine, IL 60074",
        coords: [42.1103, -88.0342],
        status: "free",
        blurb: "Repack, weigh anything full of fudge and Petoskey stones, and have breakfast with Mom. This is the morning the old plan spent on I-94.",
        tips: ["Anything fragile from Julia's travels better in a carry-on than in a checked bag."],
      },
      {
        id: "d7-flight",
        kind: "admin",
        name: "Car return and AA 1253",
        where: "Car by 1:00 · wheels up 3:20 PM",
        address: "10255 W Zemke Blvd, Chicago, IL 60666",
        coords: [41.9786, -87.8892],
        status: "booked",
        duration: "Return car by 1:00 PM Central",
        blurb: "Return the Sienna at the Multi-Modal Facility, ATS train to Terminal 3, bags, security, and the 3:20 to SFO. Gunnar in 22E (QPJBXO), Mikaela in 22D (YBEEOU).",
        tips: [
          "Photograph the odometer, the fuel gauge and all four corners before you hand over the keys.",
          "ATS runs every three to five minutes from the facility straight to Terminal 3.",
          "Boarding 2:45 PM, gate door closes 3:05 PM.",
        ],
      },
    ],
    momSaid: `9/21
