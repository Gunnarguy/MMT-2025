...
SLEEP HERE 2 nights: Lighthouse View Hotel, 699 N Huron Ave, Mackinaw City, MI 49701  Ph 231/436.5304 $298`,
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    route: "7:30 boat over, breakfast, the town, the Grand Hotel porch, boat back when you feel like it",
    miles: 0,
    driveMinutes: 0,
    sunset: "7:46 PM",
    sleep: bed("mackinaw-city"),
    lede:
      "Walk to the dock at 6:55 for the 7:30 boat. Breakfast on Main Street, then the town: shops, fudge, the harbor. Late morning, walk up Cadotte to the Grand Hotel for the porch and the grounds. Bikes if the mood strikes, the fort if it doesn't. Boats back run hourly all afternoon, so nothing is on a clock except the one that gets you there.",
    flags: [
      {
        level: "ok",
    ...
    stops: [
      ...
      },
      {
        ...
        where: "11:30 · the porch and the grounds · about an hour",
        address: "286 Grand Ave, Mackinac Island, MI 49757",
        coords: [45.8478, -84.6238],
        status: "confirmed",
        cost: "$14 adult · $7 ages 6–12 · under 5 free",
        hours: "Admissions 9:00 AM – 6:00 PM daily",
        duration: "1–1.5 hours",
        phone: "906-847-3331",
        url: "https://www.grandhotel.com/purchase-admissions/",
        urlLabel: "Admissions",
        blurb: "660 feet of front porch, geraniums the whole length of it, rocking chairs facing the Straits. Admission buys the porch, the public rooms and the gardens, and hands you a stamped brochure with a map for walking it yourself.",
        tips: [
          "Walk up Cadotte Ave from Main Street: about a third of a mile, uphill, 10 to 15 minutes. A horse taxi does it if legs are done.",
          "Daytime is casual. The jacket-and-tie rule only starts at 6:30 PM, long after you are gone.",
          "The pool is not included, and it is not the point.",
          "The Grand Luncheon in the Main Dining Room and afternoon tea in the Parlor both cost extra and are worth asking about at the admissions desk.",
        ],
        source: "Grand Hotel admissions and policies pages; 2026 rate (checked 2026-09-17)",
