...
TRY:  White Pine Village, Port Museum, Check out dock`,
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    lede:
      "Out of Ludington at 8:00. Two hours at the dunes (climb the first hill, drive the loop to Overlook 9), lunch on the docks at Fishtown, Petoskey stones on Van's Beach, and into Traverse City by three with the evening free. Revised 2026-09-15 from Mom's document; the dunes are two hours, not four.",
    flags: [
      {
        level: "ok",
      ...
      },
      {
        ...
        fix: "If the dunes run long, skip Glen Haven, not Fishtown.",
      },
    ],
    legs: [
      {
        label: "Ludington → Dune Climb",
        at: 1,
        minutes: 115,
        miles: 80,
    ...
    stops: [
      ...
      },
      {
        ...
        kind: "anchor",
        name: "Dune Climb",
        where: "9:55 · 30–45 minutes · Glen Arbor, MI",
        ...
        duration: "30–45 min",
        phone: "231-326-4700",
        blurb: "A 110-foot wall of sand above Little Glen Lake. Climb the first crest for the view; the full trek to Lake Michigan is 3.5 miles of sand and is not today's plan.",
        tips: [
          "Socks or closed shoes; the sand is loose and can be hot by late morning.",
          "Water from the car. Bathrooms at the parking lot.",
          "Whoever isn't climbing has a bench and the same view from the bottom.",
        ],
      ...
      },
      {
        ...
        where: "10:40 · about 50 minutes · one-way 7.4-mile loop",
        ...
        tips: [
          "Entrance is 2 miles south of the Dune Climb on M-109; the loop is one-way, so drive it once.",
      ...
      },
      {
        ...
        where: "11:35 · 25 minutes · only if the morning is on time",
      ...
      },
      {
        ...
        where: "12:40 · lunch and a walk · 1.5 hours",
      ...
      },
      {
        ...
        where: "About 3:00 · 1465 US-31 N, on East Grand Traverse Bay",
