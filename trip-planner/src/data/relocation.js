 ...
 * a full livability workup: 45 web-research jobs across three rounds, then a
...
export const SCOUT_META = {
  ...
  method:
    "45 research jobs in 3 rounds + a verification round re-deriving every key figure from independent sources: Redfin/Zillow/Realtor/CREA, MIT Living Wage, FBI-derived aggregators, NOAA 1991–2020 normals, FCC/BroadbandNow, and the Michigan Treasury's official 2025 millage compilation (Form L-4029).",
  confirmed: 55,
  corrected: 26,
};
...
export const RELOCATION_TOWNS = [
  ...
  },
  {
    ...
    drive: "≈287 mi · 4:34",
    verdict:
      "One of the two quiet winners. Zero lead lines on record, modest snow, DTW twenty minutes away, and the trip's own overnight stop — you'll see it with your own eyes on night seven.",
  },
  {
  ...
  },
  {
    ...
    drive: "≈387 mi · 5:57",
    verdict:
      "The one town where the two research rounds genuinely disagree on price — $525k vs $729k median — because waterfront estates whipsaw a tiny market. Good fiber, low crime on a small base, and a PFAS site at the municipal well field worth understanding before buying. Minutes closer to Palatine than Petoskey, despite what round one claimed.",
  },
  {
    id: "scout-glen-arbor",
