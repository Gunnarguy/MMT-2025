...
export const ELEVATION_PROFILE = [
  { mile: 0, label: "O'Hare / Chicago", elev: 668, day: "d0" },
  { mile: 15, label: "Palatine Home", elev: 740, day: "d0" },
  { mile: 70, label: "Indiana Dunes", elev: 590, day: "d1" },
  { mile: 175, label: "Grand Rapids Valley", elev: 640, day: "d1" },
  { mile: 270, label: "Ludington Harbor", elev: 585, day: "d1" },
  { mile: 335, label: "Traverse City Shore", elev: 600, day: "d2" },
  { mile: 380, label: "Sleeping Bear Dunes Bluff", elev: 1030, day: "d2" },
  { mile: 450, label: "Leelanau Moraines", elev: 860, day: "d2" },
  { mile: 520, label: "Charlevoix & Petoskey", elev: 610, day: "d3" },
  { mile: 580, label: "Mackinaw City Harbor", elev: 590, day: "d3" },
  { mile: 590, label: "Mackinac Island Bluff", elev: 720, day: "d4" },
  { mile: 660, label: "Gaylord Plateau (I-75 Highpoint)", elev: 1348, day: "d5" },
  { mile: 790, label: "Frankenmuth Valley", elev: 630, day: "d5" },
  { mile: 880, label: "Port Huron / St. Clair River", elev: 595, day: "d5" },
  { mile: 945, label: "Sarnia, Ontario", elev: 600, day: "d6" },
  { mile: 1020, label: "Detroit River Waterfront", elev: 575, day: "d6" },
  { mile: 1060, label: "Ann Arbor / Huron Hills", elev: 840, day: "d7" },
  { mile: 1180, label: "Kalamazoo Moraines", elev: 780, day: "d7" },
  { mile: 1330, label: "SW Michigan / New Buffalo", elev: 620, day: "d7" },
  { mile: 1430, label: "O'Hare Return", elev: 668, day: "d7" },
];
