...
const SUN_DATA = {
  ...
  d2: {
    ...
    blocks: [
      ...
      { start: 9.9, end: 10.8, icon: "🌲", short: "Scenic Drive", title: "Pierce Stocking Scenic Drive", detail: "The loop to Overlook 9", timeStr: "9:55 – 10:50 AM", duration: "55m", type: "anchor" },
      { start: 10.8, end: 11.15, icon: "🏖️", short: "Dune, from below", title: "The Dune Climb, from the bottom", detail: "Benches at the foot of the sand, photo, no climbing", timeStr: "10:50 – 11:10 AM", duration: "20m", type: "anchor" },
      { start: 11.15, end: 11.6, icon: "🌊", short: "Glen Haven", title: "Glen Haven beach", detail: "Toes in the lake, the Cannery boathouse", timeStr: "11:10 – 11:35 AM", duration: "25m", type: "anchor" },
      { start: 11.6, end: 12.25, icon: "🚗", short: "To Leland", title: "M-22 to Leland", detail: "19 miles through Glen Arbor", timeStr: "11:35 AM – 12:15 PM", duration: "35m", type: "drive" },
      { start: 12.25, end: 14.0, icon: "🐟", short: "Fishtown", title: "Fishtown lunch and Van's Beach", detail: "Cheese Shanty, Carlson's, Petoskey stones", timeStr: "12:15 – 2:00 PM", duration: "1h 45m", type: "food" },
      { start: 14.0, end: 14.75, icon: "🚗", short: "To Traverse City", title: "Leland to Brio Beach Inn", detail: "M-204, M-72, US-31 along East Bay, 30 miles", timeStr: "2:00 – 2:45 PM", duration: "45m", type: "drive" },
      { start: 14.75, end: 17.0, icon: "🏨", short: "Brio Beach Inn", title: "Check in, beach, nothing", detail: "150 feet of private sand on the bay", timeStr: "2:45 – 5:00 PM", duration: "2h 15m", type: "stay" },
