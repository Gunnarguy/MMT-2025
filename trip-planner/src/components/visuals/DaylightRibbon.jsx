...
const SUN_DATA = {
  ...
  d4: {
    ...
    blocks: [
      ...
      { start: 11.4, end: 12.75, icon: "🏛️", short: "Grand Hotel", title: "The Grand Hotel porch and grounds", detail: "Up Cadotte Ave; 660 feet of porch, $14 each", timeStr: "11:25 AM – 12:45 PM", duration: "1h 20m", type: "anchor" },
      { start: 12.75, end: 13.75, icon: "🍽️", short: "Lunch", title: "Lunch back in town", detail: "Or the Fort Tea Room terrace, 11 to 3", timeStr: "12:45 – 1:45 PM", duration: "1h", type: "food" },
