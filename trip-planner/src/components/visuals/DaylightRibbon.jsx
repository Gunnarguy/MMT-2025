...
const SUN_DATA = {
  ...
  d2: {
    ...
    endHour: 21.0,
    blocks: [
      { start: 8.0, end: 9.25, icon: "🚗", short: "To Frankfort", title: "Ludington to Frankfort", detail: "US-31 and M-22 up the shore, 55 miles", timeStr: "8:00 – 9:15 AM", duration: "1h 15m", type: "drive" },
      { start: 9.25, end: 9.5, icon: "☕", short: "Frankfort", title: "Coffee at Perks of Frankfort", detail: "Optional; Main Street, a block off the harbor", timeStr: "9:15 – 9:30 AM", duration: "15m", type: "food" },
      { start: 9.5, end: 9.85, icon: "🚗", short: "To Loon Lake", title: "M-22 to Loon Lake", detail: "14 miles, over the Platte River", timeStr: "9:30 – 9:50 AM", duration: "20m", type: "drive" },
      { start: 9.85, end: 10.1, icon: "🦶", short: "Loon Lake", title: "Loon Lake, toes in", detail: "Mom's toe-dip; dock, sandy bottom, restrooms", timeStr: "9:50 – 10:05 AM", duration: "15m", type: "anchor" },
      { start: 10.1, end: 10.35, icon: "🚗", short: "To Empire", title: "M-22 into Empire, M-109 to the drive", detail: "12 miles; Empire Bluff trailhead on the way if wanted", timeStr: "10:05 – 10:20 AM", duration: "15m", type: "drive" },
      { start: 10.35, end: 11.3, icon: "🌲", short: "Scenic Drive", title: "Pierce Stocking Scenic Drive", detail: "The 7.4-mile loop to Overlook 9, 450 feet over the lake", timeStr: "10:20 – 11:15 AM", duration: "55m", type: "anchor" },
      { start: 11.3, end: 12.1, icon: "🏔️", short: "Dune Climb", title: "The Dune Climb", detail: "Climb it, or the bench and the show", timeStr: "11:20 AM – 12:05 PM", duration: "45m", type: "anchor" },
      { start: 12.1, end: 12.95, icon: "🌊", short: "Glen Haven", title: "Glen Haven village, beach, Maritime Museum", detail: "General Store, blacksmith, toes in Lake Michigan; museum 1.5 mi west", timeStr: "12:10 – 12:55 PM", duration: "45m", type: "anchor" },
      { start: 12.95, end: 13.5, icon: "🚗", short: "To Leland", title: "M-22 through Glen Arbor to Leland", detail: "21 miles; Cherry Republic stop optional", timeStr: "12:55 – 1:30 PM", duration: "35m", type: "drive" },
      { start: 13.5, end: 15.0, icon: "🐟", short: "Fishtown", title: "Fishtown lunch", detail: "Cheese Shanty, Carlson's, the docks", timeStr: "1:30 – 3:00 PM", duration: "1h 30m", type: "food" },
      { start: 15.0, end: 15.35, icon: "🪨", short: "Van's Beach", title: "Van's Beach, Petoskey stones", detail: "Two minutes' walk south of the harbor", timeStr: "3:00 – 3:20 PM", duration: "20m", type: "anchor" },
      { start: 15.35, end: 16.1, icon: "🚗", short: "To Traverse City", title: "Leland to Brio Beach Inn", detail: "M-204, M-72, US-31 along East Bay, 30 miles", timeStr: "3:20 – 4:05 PM", duration: "45m", type: "drive" },
      { start: 16.1, end: 17.5, icon: "🏨", short: "Brio Beach Inn", title: "Check in, beach, nothing", detail: "150 feet of private sand on the bay", timeStr: "4:05 – 5:30 PM", duration: "1h 25m", type: "stay" },
      { start: 17.5, end: 18.4, icon: "🍷", short: "Left Foot Charley", title: "A glass at Left Foot Charley", detail: "Optional; urban winery, open until 7", timeStr: "5:30 – 6:25 PM", duration: "55m", type: "anchor" },
