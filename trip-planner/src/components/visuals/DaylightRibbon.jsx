...
const SUN_DATA = {
  ...
  d4: {
    ...
    blocks: [
      ...
      { start: 9.0, end: 11.4, icon: "🛍️", short: "The town", title: "Shops, fudge, the harbor", detail: "Shops open 9 to 10; Market Street behind Main", timeStr: "9:00 – 11:25 AM", duration: "2h 25m", type: "anchor" },
      { start: 11.4, end: 12.4, icon: "🏛️", short: "The Grand", title: "The Grand Hotel from Cadotte Ave", detail: "Public road under the hotel; West Bluff cottages after", timeStr: "11:25 AM – 12:15 PM", duration: "50m", type: "anchor" },
      { start: 12.4, end: 13.75, icon: "🍽️", short: "Lunch", title: "Lunch back in town", detail: "Or the Fort Tea Room terrace, 11 to 3", timeStr: "12:30 – 1:45 PM", duration: "1h 15m", type: "food" },
      { start: 13.75, end: 16.0, icon: "🚲", short: "Bikes or fort", title: "Bikes, the fort, or neither", detail: "M-185 is 8.2 flat miles; the fort closes at 5", timeStr: "1:45 – 4:00 PM", duration: "2h 15m", type: "anchor" },
